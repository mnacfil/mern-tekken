...
const StartStep = () => {
  ...
  return (
    <>
      <div className="w-full flex gap-6 text-slate-900">
        ...
        <Card className="border-slate-100  w-[550px] ">
          <CardHeader>
            <CardTitle>Commentary</CardTitle>
          </CardHeader>
          <CardContent className="text-sm max-h-[400px] overflow-y-auto">
                ...
                >
                  ...
                  {move.action === "Heal" && (
                    <span className="text-muted-foreground">
                      use <span className="text-green-500">{move.damage} </span>{" "}
                    </span>
                  )}
